...
export default function AnimatedTitle({
  ...
  return (
    <div className={`relative ${height} w-full flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900`}>
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
        ...
        >
          {/* Main Title */}
          <div className="mb-8">
            <h1 className="text-4xl sm:text-6xl md:text-7xl font-black mb-4 tracking-tighter leading-none">
